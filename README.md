...
This personal website is constructed based off `Not Pure Poole`, an open-sourced template under the terms of the [MIT License](https://opensource.org/licenses/MIT).
