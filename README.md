...
All the original posts and materials are licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) by the author, Alex Guangyuan Wang. His personal website is constructed based off `Not Pure Poole`, an open-sourced theme under the terms of the [MIT License](https://opensource.org/licenses/MIT).
